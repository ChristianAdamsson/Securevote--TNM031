...
public class CLT {
	...
	public void run() {
		...
		//	BufferedReader inCTF = new BufferedReader( new InputStreamReader( incoming.getInputStream() ) );
		//	PrintWriter outCTF = new PrintWriter( incoming.getOutputStream(), true );			
